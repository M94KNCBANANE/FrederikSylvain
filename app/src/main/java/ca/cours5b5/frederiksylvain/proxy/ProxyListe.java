...
public class ProxyListe extends Proxy implements Fournisseur {
    ...
    DatabaseReference test= super.noeudServeur.push();
    test.setValue(valeur);
    noeudsAjoutes.add(test);
    ...
    protected Query getRequete(){
        return super.noeudServeur.orderByKey().limitToFirst(GConstantes.NOMBRE_DE_VALEURS_A_CHARGER_DU_SERVEUR_PAR_DEFAULT);
